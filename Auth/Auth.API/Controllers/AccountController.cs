using Auth.API.Dtos;
using Auth.API.Infrastructure.Attributes;
...
namespace Auth.API.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> Login(LoginInputModel model, string returnUrl, string button)
        {
        ...
        public async Task<IActionResult> Logout(LogoutInputModel model)
        {
            ...
            if (User?.Identity.IsAuthenticated == true)
            {
                ...
                // manual removing cookies, since method SignOutAsync does not work correct.
